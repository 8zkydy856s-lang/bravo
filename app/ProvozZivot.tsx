...
const PROVOZ: Record<string, string> = {
  cz: `<span class="veta veta1">Otevírací doba je <em>přibližná</em> a&nbsp;závisí na&nbsp;<em>počasí</em>.</span><span class="veta veta2"><span class="cast">Než se vydám <span class="morf-slot"><span class="chv-za">za&nbsp;</span><span class="chv-jadro">chvíli</span><span class="fx-k">&nbsp;k</span></span> <span class="anchor">BraVo</span>,</span><span class="cast"><em>vždy</em> nejdřív <span class="struna-spocin">spočinu</span> <span class="anchor">ZDE</span> a&nbsp;naladím se,</span><span class="cast">abychom se skutečně sešli <span class="anchor">OBA</span>&nbsp;připraveni.</span></span><span class="veta veta3">Těším se, děkuji <span class="anchor">TOBĚ</span> za&nbsp;pochopení<span class="fx-symbol" aria-hidden="true">${SYMBOL_SVG}</span></span>`,
  en: `<span class="veta veta1">Hours are <em>approximate</em> and depend on the <em>weather</em>.</span><span class="veta veta2"><span class="cast">Before I set out <span class="morf-slot"><span class="chv-za">for&nbsp;</span><span class="chv-jadro">a&nbsp;moment</span><span class="fx-k">&nbsp;to</span></span> <span class="anchor">BraVo</span>,</span><span class="cast">I <em>always</em> <span class="struna-spocin">rest</span> <span class="anchor">HERE</span> first and tune in,</span><span class="cast">so we truly meet <span class="anchor">BOTH</span> of us ready.</span></span><span class="veta veta3">Looking forward, thank <span class="anchor">YOU</span> for understanding<span class="fx-symbol" aria-hidden="true">${SYMBOL_SVG}</span></span>`,
  fr: `<span class="veta veta1">Les horaires sont <em>approximatifs</em>, selon la <em>météo</em>.</span><span class="veta veta2"><span class="cast">Avant de partir <span class="morf-slot"><span class="chv-za">dans&nbsp;</span><span class="chv-jadro">un&nbsp;instant</span><span class="fx-k">&nbsp;vers</span></span> <span class="anchor">BraVo</span>,</span><span class="cast"><span class="struna-spocin">je souffle</span> <em>d'abord</em> <span class="anchor">ICI</span> et je me mets au diapason,</span><span class="cast">pour qu'on se retrouve vraiment prêts <span class="anchor">TOUS LES DEUX</span>.</span></span><span class="veta veta3">Au plaisir, merci <span class="anchor">à&nbsp;TOI</span> pour la compréhension<span class="fx-symbol" aria-hidden="true">${SYMBOL_SVG}</span></span>`,
  de: `<span class="veta veta1">Die Öffnungszeiten sind <em>ungefähr</em>, je nach <em>Wetter</em>.</span><span class="veta veta2"><span class="cast">Bevor ich <span class="morf-slot"><span class="chv-za">für&nbsp;</span><span class="chv-jadro">eine&nbsp;Weile</span><span class="fx-k">&nbsp;zu</span></span> <span class="anchor">BraVo</span> aufbreche,</span><span class="cast"><span class="struna-spocin">verweile ich</span> <em>zuerst</em> <span class="anchor">HIER</span> und stimme mich ein,</span><span class="cast">damit wir uns wirklich <span class="anchor">BEIDE</span> bereit begegnen.</span></span><span class="veta veta3">Ich freue mich, danke <span class="anchor">DIR</span> fürs Verständnis<span class="fx-symbol" aria-hidden="true">${SYMBOL_SVG}</span></span>`,
  lu: `<span class="veta veta1">D'Öffnungszäiten si <em>ongeféier</em>, je no <em>Wieder</em>.</span><span class="veta veta2"><span class="cast">Ier ech <span class="morf-slot"><span class="chv-za">fir&nbsp;</span><span class="chv-jadro">eng&nbsp;Weil</span><span class="fx-k">&nbsp;op</span></span> <span class="anchor">BraVo</span> lassginn,</span><span class="cast"><span class="struna-spocin">verweilen ech</span> <em>als éischt</em> <span class="anchor">HEI</span> a stëmme mech an,</span><span class="cast">fir datt mir eis wierklech <span class="anchor">BEIDS</span> prett begéinen.</span></span><span class="veta veta3">Ech freeë mech, merci <span class="anchor">DIR</span> fir d'Verständnis<span class="fx-symbol" aria-hidden="true">${SYMBOL_SVG}</span></span>`,
}
