...
// SYMBOL VDĚČNOSTI (dva tulipány / sepjaté ruce) — nahrazuje dřívější květ ❀ za slovem „pochopení".
// Barva i záře jdou přes CSS proměnné --bravo-stav-barva / --bravo-stav-glow (nastaví KioskStatus dle otevřeno/zavřeno).
// stroke=currentColor → symbol má barvu stavu; velikost/záře řeší .fx-symbol v globals.css.
const SYMBOL_SVG = `<svg viewBox="65 102 230 318" xmlns="http://www.w3.org/2000/svg"><g fill="none" stroke="currentColor" stroke-width="7" stroke-linecap="round" stroke-linejoin="round"><g transform="translate(180,248) scale(0.795) translate(-180,-248)"><path d="M174 84 C 140 110, 120 170, 132 214 C 140 240, 158 250, 170 246 C 190 200, 188 132, 174 84 Z"/><path d="M186 84 C 220 110, 240 170, 228 214 C 220 240, 202 250, 190 246 C 170 200, 172 132, 186 84 Z"/></g><g transform="translate(180,248) scale(1.05) translate(-180,-248)"><path d="M180 248 C 180 254, 180 258, 180 264"/><path d="M180 264 C 172 298, 162 322, 150 342"/><path d="M152 328 C 118 340, 90 366, 80 402 C 96 392, 118 384, 140 380 C 152 366, 158 352, 158 346 Z"/><path d="M84 398 C 96 408, 116 402, 132 390" stroke-width="3.4"/><path d="M138 356 L110 380" stroke-width="2.8"/><path d="M146 352 L122 372" stroke-width="2.6"/><path d="M180 264 C 188 298, 198 322, 210 342"/><path d="M208 328 C 242 340, 270 366, 280 402 C 264 392, 242 384, 220 380 C 208 366, 202 352, 202 346 Z"/><path d="M276 398 C 264 408, 244 402, 228 390" stroke-width="3.4"/><path d="M222 356 L250 380" stroke-width="2.8"/><path d="M214 352 L238 372" stroke-width="2.6"/></g></g></svg>`
...
export default function ProvozZivot() {
  ...
  return (
    <p ref={ref} className="landing-band-text veta-blok" style={{ fontSize: '14px', lineHeight: 1.7, color: '#574b3a' }}
