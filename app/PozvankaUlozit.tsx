...
const SYMBOL_SVG = `<svg viewBox="65 102 230 318" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:100%;overflow:visible"><g stroke-width="7" stroke-linecap="round" stroke-linejoin="round"><g transform="translate(180,248) scale(0.795) translate(-180,-248)"><path fill="#f2ad4e" stroke="#d98b34" d="M174 84 C 140 110, 120 170, 132 214 C 140 240, 158 250, 170 246 C 190 200, 188 132, 174 84 Z"/><path fill="#f2ad4e" stroke="#d98b34" d="M186 84 C 220 110, 240 170, 228 214 C 220 240, 202 250, 190 246 C 170 200, 172 132, 186 84 Z"/></g><g transform="translate(180,248) scale(1.05) translate(-180,-248)"><path fill="none" stroke="#57913a" d="M180 248 C 174 288, 162 320, 150 342"/><path fill="#6faa4a" stroke="#4a7c30" d="M152 328 C 118 340, 90 366, 80 402 C 96 392, 118 384, 140 380 C 152 366, 158 352, 158 346 Z"/><path fill="none" stroke="#57913a" d="M180 248 C 186 288, 198 320, 210 342"/><path fill="#6faa4a" stroke="#4a7c30" d="M208 328 C 242 340, 270 366, 280 402 C 264 392, 242 384, 220 380 C 208 366, 202 352, 202 346 Z"/></g></g></svg>`
        ...
        <div style={{ display: 'flex', alignItems: 'flex-start', gap: 12 }}>
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: 8 }}>
              <p style={{ margin: 0, fontSize: 14, fontWeight: 600, color: '#3d3123', flex: 1, lineHeight: 1.35 }}>
                {t.nadpis}{'  '}
                <span aria-hidden="true" style={{ display: 'inline-block', width: 30, height: 40, verticalAlign: 'middle', marginLeft: 2 }} dangerouslySetInnerHTML={{ __html: SYMBOL_SVG }} />
              </p>
            ...
            <p style={{ margin: '6px 0 0', fontSize: 12.5, color: '#6f6253', lineHeight: 1.5 }}>{t.t1}</p>
            <p style={{ margin: '4px 0 0', fontSize: 13, color: '#3d3123', lineHeight: 1.5, fontWeight: 500 }}>
              {t.akce}{' '}
              <span style={{ display: 'inline-block', animation: 'pozv-zar 2.4s ease-in-out infinite' }}>😌</span>{' '}
              <span style={{ color: '#8a7f70' }}>{t.dekuji}</span>
            </p>
